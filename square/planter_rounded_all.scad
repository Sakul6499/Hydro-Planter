      ...
      difference() {
        union() {
          ...
          color("lime") difference() {
            roundedcube(size = [ $width, $depth, $height - $connection ],
                        center = true, radius = 2.5, apply_to = "all");
          ...
          color("tomato") translate([ 0, 0, -($height / 2) ]) {
            union() {
              ...
              translate([ 0, 0, $connection ])
                  roundedcube(size = [ $width, $depth, $connection ], center = true, radius = 2.5, apply_to = "all");
            }
          }
        }
        // DIFF
